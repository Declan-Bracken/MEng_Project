...
def generate_dataset_json(original_files, response_files, output_file):
    ...
    for input_file in response_files:
        with open(input_file, 'r') as f:
            for line in f:
                ...
                local_path = download_images([image_url], "Synthetic_Image_Annotation/images/")
...
if __name__ == "__main__":
    ...
    image_folder_path = "Synthetic_Image_Annotation/images/"
    ...
    generate_dataset_json(original_files, response_files, output_file)
