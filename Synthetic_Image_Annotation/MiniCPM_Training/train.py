...
class SavePredictionsCallback(TrainerCallback):
    def __init__(self, eval_dataset, output_dir):
    ...
    def on_evaluate(self, args, state: TrainerState, control: TrainerControl, **kwargs):
        ...
        output_path = os.path.join(self.output_dir, f"predictions_step_{state.global_step}.json")
...
def train():
    ...
    # Add custom callback for saving predictions
    save_predictions_callback = SavePredictionsCallback(
        eval_dataset=data_module['eval_dataset'],
        output_dir=training_args.output_dir
    )
    trainer.add_callback(save_predictions_callback)
